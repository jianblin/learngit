...
#define GSENSOR_DATA_LENGTH		16

extern float gsensor_data[GSENSOR_DATA_LENGTH][3];
extern unsigned int gsensor_data_wr;
extern unsigned int gsensor_data_rd;
